...
from findElementsOnDomainBoundary import findElementsOnDomainBoundary
...
def main():
    ...
    nFacesElement = 4    
    pathFileOut = 'elementSetsOnDomainBoundaries.inp'
    ...
    listNamesElementSets, listElementsOnBoundaries = findElementsOnDomainBoundary(listCoordMinDomainBoundary,listCoordMaxDomainBoundary,listElementIDs,listElementConnectivity,listNodalCoordinates,nFacesElement)    
